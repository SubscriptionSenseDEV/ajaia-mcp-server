    ...
    tools: [
      {
        ...
        description:
          'Analyze a Jira issue or Azure DevOps work item using AI. Provides insights, suggestions, and analysis.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'Search for work items in Jira or Azure DevOps using natural language or JQL/WIQL queries.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            updates: {
              type: 'object',
              description:
                'Fields to update (e.g., { "status": "In Progress", "assignee": "user@email.com" })',
            },
          },
      ...
      },
      {
        name: 'ai_chat',
        description:
          'Have a conversation with AJAIA AI about your work items, projects, or get help with project management.',
        inputSchema: {
          type: 'object',
          properties: {
            message: {
...

      {
        name: 'breakdown_epic',
        description:
          'AI-powered epic decomposition. Breaks an epic into features, stories, tasks, and test cases. Can auto-create them in Jira/ADO.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'AI-generate test cases (functional, edge, integration, regression) from a work item. Optionally creates them in the platform.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'Batch create child tasks/subtasks under a parent work item (up to 20 at once).',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'Create a relationship between two work items (blocks, is-blocked-by, relates-to, parent-child, duplicate, etc.).',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
            ...
            linkType: {
              type: 'string',
              description:
                'Link type. Jira: "blocks", "is blocked by", "relates to", "duplicates", "is duplicated by", "clones", "is cloned by". ADO: "System.LinkTypes.Hierarchy-Forward", "System.LinkTypes.Related", "System.LinkTypes.Dependency-Forward".',
            },
            comment: {
              type: 'string',
      ...
      },
      {
        ...
        description:
          'Deep clone a work item including fields, labels, and auto-link back to the original.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        name: 'bulk_update',
        description:
          'Update up to 50 work items at once. Change status, add comments, update fields in batch.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        name: 'manage_sprint',
        description:
          'Sprint management: list sprints, get sprint details, view sprint items, or move items between sprints.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
            ...
            action: {
              ...
              description:
                'Action: "list" all sprints, "get" sprint details, "items" in sprint, "move" item to sprint',
            },
            sprintId: {
              type: 'string',
...

      {
        name: 'daily_focus',
        description:
          'AI-powered daily priorities and focus metrics. Role-aware (developer, manager, QE). Returns top actions, blockers, and key metrics.',
        inputSchema: {
          type: 'object',
          properties: {
            role: {
      ...
      },
      {
        name: 'risk_radar',
        description:
          'Comprehensive project risk scoring. Identifies overdue items, blocked chains, scope creep, and team overload with severity ratings.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        name: 'flow_metrics',
        description:
          'Agile flow metrics: cycle time, lead time, throughput, WIP, and bottleneck identification.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        name: 'forecast',
        description:
          'Project completion forecasting with optimistic, expected, and pessimistic scenarios based on historical velocity.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        ...
        description:
          'AI-generated team coaching suggestions and improvement actions based on current project health.',
        inputSchema: {
          type: 'object',
          properties: {
            role: {
      ...
      },
      {
        ...
        description:
          'Sprint-by-sprint velocity and delivery trend analysis. Shows acceleration/deceleration patterns.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        ...
        description:
          'Workload distribution analysis: work by status, priority, type, and team member with balance indicators.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        ...
        description:
          'Sprint commitment vs delivery predictability. Shows historical accuracy and confidence interval.',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        ...
        description:
          'Evidence-backed completeness and readiness scan for epics, features, or stories. Returns a confidence score with specific gaps.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
...

      {
        ...
        description:
          'AI-generate Gherkin or bullet-point acceptance criteria for a work item. Perfect for POs and BAs.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'AI-powered story point estimation with detailed reasoning, complexity factors, and confidence level.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        name: 'suggest_labels',
        description:
          'AI-powered label/tag suggestions based on work item content, title, and description patterns.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        ...
        description:
          'AI-powered team member assignment recommendation based on expertise, workload, and availability.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
      ...
      },
      {
        name: 'quick_summary',
        description:
          'AI-generated concise summary of a work item including status, key points, blockers, and next steps.',
        inputSchema: {
          type: 'object',
          properties: {
            platform: {
...

      {
        ...
        description:
          'Migrate a work item between Jira and Azure DevOps (bidirectional). Copies fields, maps types, and optionally includes comments and attachments.',
        inputSchema: {
          type: 'object',
          properties: {
            sourcePlatform: {
  ...
  try {
    ...
    switch (name) {
      case 'analyze_work_item':
        result = await client.analyzeWorkItem(
          toolArgs.platform as string,
          toolArgs.itemId as string,
          toolArgs.analysisType as string
        );
        break;

      case 'search_work_items':
        result = await client.searchWorkItems(
          toolArgs.platform as string,
          toolArgs.query as string,
          toolArgs.maxResults as number
        );
        break;

      case 'create_work_item':
        result = await client.createWorkItem(toolArgs.platform as string, toolArgs as any);
        break;
      ...
      case 'update_work_item':
        result = await client.updateWorkItem(
          toolArgs.platform as string,
          toolArgs.itemId as string,
          toolArgs.updates as Record<string, any>
        );
        break;
      ...
      case 'get_my_work_items':
        result = await client.getMyWorkItems(
          toolArgs.platform as string,
      ...
      case 'generate_report':
        result = await client.generateReport(
          toolArgs.platform as string,
          toolArgs.project as string,
          toolArgs.reportType as string,
          toolArgs.sprintId as string
        );
        break;

      case 'ai_chat':
        result = await client.aiChat(
          toolArgs.message as string,
          toolArgs.context as Record<string, any>
        );
        break;
      ...
      case 'breakdown_epic':
        result = await client.breakdownEpic(
          toolArgs.platform as string,
          toolArgs.epicId as string,
          toolArgs.createStories as boolean,
          toolArgs.phase as string
        );
        break;

      case 'generate_test_cases':
        result = await client.generateTestCases(
          toolArgs.platform as string,
          toolArgs.workItemId as string,
          toolArgs.createTestCases as boolean,
          toolArgs.testType as string
        );
        break;

      case 'create_subtasks':
        result = await client.createSubtasks(
          toolArgs.platform as string,
          toolArgs.parentId as string,
          toolArgs.subtasks as any[]
        );
        break;

      case 'link_work_items':
        result = await client.linkWorkItems(
          toolArgs.platform as string,
          toolArgs.sourceId as string,
          toolArgs.targetId as string,
          toolArgs.linkType as string,
          toolArgs.comment as string
        );
        break;

      case 'clone_work_item':
        result = await client.cloneWorkItem(
          toolArgs.platform as string,
          toolArgs.workItemId as string,
          toolArgs.titlePrefix as string,
          toolArgs.includeAttachments as boolean
        );
        break;

      case 'bulk_update':
        result = await client.bulkUpdate(
          toolArgs.platform as string,
          toolArgs.workItemIds as string[],
          toolArgs.updates as Record<string, any>,
          toolArgs.addComment as string
        );
        break;

      case 'manage_sprint':
        result = await client.manageSprint(
          toolArgs.platform as string,
          toolArgs.action as string,
          toolArgs.sprintId as string,
          toolArgs.workItemId as string,
          toolArgs.targetSprintId as string
        );
        break;
      ...
      case 'daily_focus':
        result = await client.dailyFocus(toolArgs.role as string);
        break;
      ...
      case 'coaching_actions':
        result = await client.coachingActions(toolArgs.role as string);
        break;
      ...
      case 'confidence_scan':
        result = await client.confidenceScan(
          toolArgs.platform as string,
          toolArgs.targetType as string,
          toolArgs.targetId as string,
          toolArgs.targetTitle as string
        );
        break;
      ...
      case 'generate_acceptance_criteria':
        result = await client.generateAcceptanceCriteria(
          toolArgs.platform as string,
          toolArgs.workItemId as string,
          toolArgs.format as string
        );
        break;

      case 'estimate_story_points':
        result = await client.estimateStoryPoints(
          toolArgs.platform as string,
          toolArgs.workItemId as string
        );
        break;
      ...
      case 'suggest_labels':
        result = await client.suggestLabels(
          toolArgs.platform as string,
          toolArgs.workItemId as string
        );
        break;
      ...
      case 'recommend_assignment':
        result = await client.recommendAssignment(
          toolArgs.platform as string,
          toolArgs.workItemId as string
        );
        break;
      ...
      case 'quick_summary':
        result = await client.quickSummary(
          toolArgs.platform as string,
          toolArgs.workItemId as string
        );
        break;
      ...
      case 'migrate_work_item':
        result = await client.migrateWorkItem(
          toolArgs.sourcePlatform as string,
          toolArgs.targetPlatform as string,
          toolArgs.workItemId as string,
          toolArgs.targetProject as string,
          toolArgs.includeComments as boolean,
          toolArgs.includeAttachments as boolean
        );
        break;
